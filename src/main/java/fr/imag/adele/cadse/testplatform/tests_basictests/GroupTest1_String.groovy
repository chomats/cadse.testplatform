...
public class GroupTest1_String extends CadsegTestCase {
	...
	public void init() {
		...
		/* TEST */
		CadseTestPart tp = addTestPart(null, 'Group_basic_CADSEg','fr.imag.adele.cadse.test.basictests','fr.imag.adele.cadse.test.basictests.group.test1.Test1_String_ts_CADSEg')
		tp.deleteBundle("Model.Workspace.CADSEgroup_test1String")
		
		
		tp = addTestPart(null, 'Group_basic_Execution','fr.imag.adele.cadse.test.basictests','fr.imag.adele.cadse.test.basictests.group.test1.Test1_String_ts_execution') {
